// NOTE: manual amalgamation of tests form upstream (see below)
//       since upstream versions include headers that are not
//       installed.
...
// Copied from upstream/src/blake2-kat.h (because this header is not
// installed).
//
#define KAT_LENGTH 256

// These tables were copied from upstream/src/blake2-kat.h.
//
...
// These tests were copied from upstream/src/blake2*-test.c.
//
static uint8_t key[BLAKE2B_KEYBYTES];
static uint8_t buf[KAT_LENGTH];
